<template>
  <body class=" app-SaeApp model-paciente change-list">
    ...
    <div id="container">
        ...
        <div class="breadcrumbs">
            <a href="/#/saeinfo">Início</a> › Pacientes
        </div>
        <!-- Content -->
        <div id="content" class="flex">

            <h1>Selecione paciente para modificar</h1>
            ...
            <div id="content-main">
                ...
                <div class="module" id="changelist">
                    ...
                    <form id="changelist-form" action="" method="post" novalidate="">
                        <div class="actions">
                            <label>Ação:
                              <select name="action">
                                ...
                                <option value="delete_selected">Remover pacientes selecionados</option>
                                <option value="aplicar_processo_SAE">Aplicar processo SAE</option>
                                <option value="visualizar_historico">Visualizar historico</option>
                                <option value="visualizar_plano_de_cuidados">Visualizar plano de cuidados</option>
                                <option value="aplicar_escala_de_Braden">Aplicar escala de Braden</option>
                              </select>
                            </label>
                            ...
                            <span class="action-counter" style="display: inline;">0 de 11 selecionados</span>
                        </div>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="sortable column-Nome">
                                            <div class="text"><a>Nome</a></div>
                                            <div class="clear"></div>
                                        </th>
                                        <th scope="col" class="sortable column-Leito">
                                            <div class="text"><a>Leito</a></div>
                                            <div class="clear"></div>
                                        </th>
                                        <th scope="col" class="sortable column-Data_de_internacao">
                                            <div class="text"><a>Data de internação</a></div>
                                            <div class="clear"></div>
                                        </th>
                                    </tr>
                                </thead>
                        ...
                        <p v-if='pacientes' class="paginator">
...
export default {
  ...
  methods: {
    getPacientes () {
      $.get('http://localhost/sae/listaPacientes.php?id')
      .then(resposta => {
